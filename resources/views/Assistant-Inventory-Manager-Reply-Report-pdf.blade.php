    ...
    <table class="bg-white">
        <thead>
            <tr>
                ...
                <th class="font-weight-bold">Phone number(s)</th>

                <th class="font-weight-bold">Report's assigned college name</th>
        ...
        <tbody>
            ...
            @foreach ($Reports as $report)
                <tr>
                    ...
                    <td>
                        @foreach ( $report['item']->user->phone as $phone)

                        <h5 class="font-16">{{$phone->phone_number }}</h5>
        ...
        @foreach ($Reports as $report)
            <div class="resource-name-container">
                ...
                <span class="resource-name-label">
                    Report name with a University of Dodoma report id of
                    {{ $report['item']->id }}
                </span>
