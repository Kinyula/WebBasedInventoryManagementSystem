        ...
        @foreach ($Reports as $report)
            ...
            <div class="description-container">
                ...
                <span class="description-label">
                    Description on the reported resource called {{ $report['item']->chasResources->resource_name }} with
                    a
                    University of Dodoma store asset id of {{ $report['item']->chasResources->asset_id }}
                </span>
        ...
        <table class="table bg-white">
            ...
            <tbody>
                ...
                @foreach ($Reports as $report)
                    <tr>
                        <td class="td">
                            <h5 class="font-16">{{ $report['item']->chasResources->resource_name }}</h5>
