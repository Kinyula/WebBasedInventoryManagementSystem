        ...
        @foreach ($Reports as $report)
            <div class="resource-name-container">
                ...
                <span class="resource-name">
                    ...
                    {{ $report['item']->chssResources->resource_name }}
            ...
            <div class="description-container">
                ...
                <span class="description-label">
                    Description on the reported resource called {{ $report['item']->chssResources->resource_name }} with
                    a
                    University of Dodoma store asset id of {{ $report['item']->chssResources->asset_id }}
                </span>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @foreach ($Reports as $report)
                    <tr>
                        <td class="td">
                            <h5 class="font-16">{{ $report['item']->chssResources->resource_name }}</h5>
