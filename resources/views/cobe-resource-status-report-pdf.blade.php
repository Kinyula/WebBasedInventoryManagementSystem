        ...
        @foreach ($Reports as $report)
            ...
            <div class="description-container">
                ...
                <span class="description-label">
                    Description on the reported resource called {{ $report['item']->cobeResources->resource_name }} with
                    a
                    University of Dodoma store asset id of {{ $report['item']->cobeResources->asset_id }}
                </span>
