            ...
            <form class="d-flex">
                <div class="form-group mb-0">
                    ...
                    <input type="search" class="form-control search-input" placeholder="Search Here..."
                        wire:model.live = 'chasReportSearch' />
                ...
                @foreach ($Reports as $report)
                    <tr>
                        ...
                        <td style="text-decoration:normal"><i class="bi bi-pencil p-2"></i>
                            {{ $report->chasResources->category->category_type }}
                        </td>
                        ...
                        <td style="text-decoration:normal">
                            {{ $report->chasResources->asset_id }}
                        </td>

                        <td style="text-decoration:normal">

                            {{ $report->chasResources->id }}
                        </td>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    ...
                                    <button type="submit" class="dropdown-item"
                                        wire:click = "deleteChasReport({{ $report->id }})"
