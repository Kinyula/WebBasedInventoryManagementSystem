<div>
    <div class="card-box mb-30 p-3">
        ...
        <h2 class="h4 pd-20 text-gray-600"><i class="bi bi-plus"></i> Add CHSS resources</h2>

        <form wire:submit.prevent = "importChssResources">

            <div class="form-group display:block">
                <label for="">Upload the csv file</label>
                <input type="file" wire:model = "chssResourceImport">

                @error('chssResourceImport')
        ...
        <form wire:submit.prevent = "addChssResources">
            <div class="mt-3">
            ...
            <div class="mt-3">
                ...
                <select type="select" wire:model= "college_name"
                    ...
                    <option value="College of Humanities and Social Sciences ( CHSS )">College of Humanities and
                        Social Sciences ( CHSS )</option>
