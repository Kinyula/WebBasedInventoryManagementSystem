<div>
    <div class="card-box mb-30 p-3">
        <h2 class="h4 pd-20 text-gray-600"><i class="bi bi-plus"></i>Resource Allocation</h2>
    ...
    <div class="card-box mb-30 p-3">
        ...
        <div class="d-grid space-x-5">
            <a wire:navigate href="{{ asset('UIMS/view-resource-allocation') }}"><i class="fas fa-eye"></i> View resources allocated</a>
