<div>
    <div class="card-box mb-30 p-3">
        <h2 class="h4 pd-20 text-gray-600"><i class="fas fa-user-plus px-1"></i> Create an accountant.</h2>

        @if (session()->has('addAnAccountant'))
            <div role="alert" class="alert alert-success alert-dismissible fade show">
                <strong><i class="fas fa-check px-1"></i>{{ session('addAnAccountant') }}</strong>
        ...
        @endif
        <form wire:submit.prevent = "importAccountants">
            ...
            <button type="submit" wire:loading.attr="disabled"
                ...
                Import accountants csv file
            </button>

        </form>

        <form wire:submit.prevent = "addAccountants">
    ...
    <div class="card-box mb-30 p-3">
        <h2 class="h4 pd-20"><i class="fas fa-users px-1"></i> View created accountants</h2>
    ...
    <div class="card-box mb-30 p-3">
        ...
        @if (session()->has('deleteAccountant'))
            <div role="alert" class="alert alert-success alert-dismissible fade show">
                <strong>{{ session('deleteAccountant') }}</strong>
        ...
        <button type="submit" wire:click = "exportAccountants"
            ...
            <form class="d-flex">
                <div class="form-group mb-0">
                    ...
                    <input type="search" class="form-control search-input" placeholder="Search Here..."
                        wire:model.live = 'accountantSearch' />
            ...
            <thead>
                <tr>
                    ...
                    <th class="table-plus datatable-nosort font-weight-bold"><i class="bi bi-telephone p-2"></i>Phone
                        number</th>
                    <th class="table-plus datatable-nosort font-weight-bold">College</th>
                ...
                @if (auth()->user()->college_name == 'College of Health and Allied Science ( CHAS )')
                    @foreach ($Accountants as $accountant)
                        <tr>
                            ...
                            <td>
                                <h5 class="font-16">{{ $accountant->username }}</h5>

                            </td>


                            <td>
                                <h5 class="font-16">{{ $accountant->email }}</h5>
                            ...
                            <td style="text-decoration:normal">
                                ...
                                @foreach ($accountant->phone as $PhoneNumber)
                                    <br>
                            ...
                            <td>
                                <h5 class="font-16">{{ $accountant->college_name }}</h5>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                        ...
                                        <button type="submit" class="dropdown-item"
                                            onclick="confirm(`Are you sure you want to delete  {{ $accountant->email }}   accountant inventory manager ? `) || event.stopImmediatePropagation()"wire:click="deleteAccountant({{ $accountant->id }})"><i
