<div>
    ...
    <div class="card-box mb-30 p-3">
        ...
        @if (session()->has('deleteCiveReport'))
        <div role="alert" class="alert alert-success alert-dismissible fade show">
            <strong>{{ session('deleteCiveReport') }}</strong>
            <button class="btn btn-close"></button>
        </div>
    @endif

        <form wire:submit.prevent = 'exportCiveReportPdf'>
            ...
            <form class="d-flex">
                <div class="form-group mb-0">
                    ...
                    <input type="search" class="form-control search-input" placeholder="Search Here..."
                        wire:model.live = 'civeReportSearch' />
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    ...
                                    <button type="submit" class="dropdown-item"
                                        wire:click = "deleteCiveReport({{ $report->id }})"
