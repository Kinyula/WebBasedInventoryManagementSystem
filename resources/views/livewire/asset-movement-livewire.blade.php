<div>
        ...
        @if ($Resources->count() > 0)
            ...
            <div class="mt-3">
                <label for="Room/Office name"
                    ...
                    number <span class="text-danger text-xl">*</span></label>
    ...
    <div class="card-box p-3">
        <h2 class="h5 pd-20">View moved items</h2>
    ...
    @endif
        ...
        <table class="data-table table nowrap ">
            ...
            <tbody>
                ...
                @foreach ($MovedAssetToAreas as $resource)
                    <tr>
        ...
        <span>{{ $MovedAssetToAreas->links() }}</span>
