...
class ViewCollegeInventoryManagerLivewire extends Component
{
    ...
    {
        return view('livewire.view-college-inventory-manager-livewire', ['CollegeManagers' => User::search($this->collegeManagerSearch)->with(['phone', 'resources_to_college'])->where('role_id', '2')->where('post', '=', 'store')->paginate(15)]);
    }
